...
//	List<UserSearch> findByIsDownloadedOrderByCreatedDateDesc(String isDownloaded);
	...
	List<UserSearch> customByUserIdAndIsDownloadAndSearchValueAndDateRange(Long userId, String isDownloaded, String searchValue,
			int page, int size, Date fromDate, Date toDate);//D1
	...
	List<UserSearch> findByCreatedByAndIsDownloadedAndDateRange(Long userId, String isDownloaded, int page, int size, Date fromDate, Date toDate);//D2
	...
	List<UserSearch> customByUserIdAndSearchValueAndDateRange(Long userId, String searchValue, int page, int size, Date fromDate, Date toDate);//D3
	...
	List<UserSearch> findByUplineIdAndIsDownloadedAndDateRangeOrderByCreatedDateDesc(Long uplineId, String isDownloaded, int page,
	...
	List<UserSearch> customByIsDownloadedAndSearchValueAndDateRange(String isDownloaded, String searchValue, int page, int size, Date fromDate, Date toDate);//D9
	...
	List<UserSearch> findByIsDownloadedAndDateRange(String isDownloaded, int page, int size, Date fromDate, Date toDate);//D10
	...
	List<UserSearch> customBySearchValueAndDateRange(String searchValue, int page, int size, Date fromDate, Date toDate);//D11
	...
	long customCountByUserIdAndIsDownloadAndSearchValueAndDateRange(Long userId, String isDownloaded, String searchValue, Date fromDate, Date toDate);//DC1
	...
	long customCountByIsDownloadedAndSearchValueAndDateRange(String isDownloaded, String searchValue, Date fromDate, Date toDate);//DC9
