...
public class UserSearchController {
	...
	public ResponseEntity allQueries(@RequestParam (required=false) Long userId, @RequestParam (required=false) Long uplineId,@RequestParam (required=false) String isDownloaded, @RequestHeader(value="accessedBy", required=true) Long accessedBy) throws Exception{
			
		SearchDetailsResponse searchDetailsResponse = userSearchService.listAllQueries(userId,uplineId,isDownloaded,accessedBy);
