		...
		if(!userSearchRequest.getCountryCode().equals("IND") && !userSearchRequest.getCountryCode().equals("SEZ"))
		{
			...
			if(userSearchRequest.getTradeType().getValue() == "EXPORT")
			{
				 ...
				 while(rs.next()) {
					 ...
					 exp.setCif_value_botswanan_pula((rs.getString("cif_value_botswanan_pula") != null) ? rs.getBigDecimal("cif_value_botswanan_pula").toPlainString() : null);
					 exp.setCif_value_naira((rs.getString("cif_value_naira") != null) ? rs.getBigDecimal("cif_value_naira").toPlainString() : null);
					 ...
					 exp.setCommercial_quantity((rs.getString("commercial_quantity") != null) ? rs.getBigDecimal("commercial_quantity").toPlainString() : null);
					 ...
					 exp.setExchange_rate((rs.getString("exchange_rate") != null) ? rs.getBigDecimal("exchange_rate").toPlainString() : null);
					 ...
					 exp.setFob_value_botswanan_pula((rs.getString("fob_value_botswanan_pula") != null) ? rs.getBigDecimal("fob_value_botswanan_pula").toPlainString() : null);
					 exp.setFob_value_naira((rs.getString("fob_value_naira") != null) ? rs.getBigDecimal("fob_value_naira").toPlainString() : null);
					 exp.setFreight_value((rs.getString("freight_value") != null) ? rs.getBigDecimal("freight_value").toPlainString() : null);
					 exp.setFreight_value_botswanan_pula((rs.getString("freight_value_botswanan_pula") != null) ? rs.getBigDecimal("freight_value_botswanan_pula").toPlainString() : null);
					 exp.setFreight_value_usd((rs.getString("freight_value_usd") != null) ? rs.getBigDecimal("freight_value_usd").toPlainString() : null);
					 exp.setGross_weight((rs.getString("gross_weight") != null) ? rs.getBigDecimal("gross_weight").toPlainString() : null);
					 ...
					 exp.setInsurance_value((rs.getString("insurance_value") != null) ? rs.getBigDecimal("insurance_value").toPlainString() : null);
					 exp.setInsurance_value_botswanan_pula((rs.getString("insurance_value_botswanan_pula") != null) ? rs.getBigDecimal("insurance_value_botswanan_pula").toPlainString() : null);
					 exp.setInsurance_value_usd((rs.getString("insurance_value_usd") != null) ? rs.getBigDecimal("insurance_value_usd").toPlainString() : null);
					 exp.setItem_no(rs.getString("item_no"));
					 exp.setItem_value_cif((rs.getString("item_value_cif") != null) ? rs.getBigDecimal("item_value_cif").toPlainString() : null);
					 exp.setItem_value_fob((rs.getString("item_value_fob") != null) ? rs.getBigDecimal("item_value_fob").toPlainString() : null);
					 ...
					 exp.setNet_weight((rs.getString("net_weight") != null) ? rs.getBigDecimal("net_weight").toPlainString() : null);
					 exp.setNet_weight_unit(rs.getString("net_weight_unit"));
					 exp.setNo_of_package((rs.getString("no_of_package") != null) ? rs.getBigDecimal("no_of_package").toPlainString() : null);
					 ...
					 exp.setQuantity((rs.getString("quantity") != null) ? rs.getBigDecimal("quantity").toPlainString() : null);
					 exp.setQuantity_of_container((rs.getString("quantity_of_container") != null) ? rs.getBigDecimal("quantity_of_container").toPlainString() : null);
					 ...
					 exp.setStd_quantity((rs.getString("std_quantity") != null) ? rs.getBigDecimal("std_quantity").toPlainString() : null);
					 exp.setStd_unit(rs.getString("std_unit"));
					 exp.setSubitem_no(rs.getString("subitem_no"));
					 exp.setTax_amount((rs.getString("tax_amount") != null) ? rs.getBigDecimal("tax_amount").toPlainString() : null);
					 exp.setTotal_cif_value((rs.getString("total_cif_value") != null) ? rs.getBigDecimal("total_cif_value").toPlainString() : null);
					 exp.setTotal_fob_value((rs.getString("total_fob_value") != null) ? rs.getBigDecimal("total_fob_value").toPlainString() : null);
					 exp.setTotal_fob_value_pkr((rs.getString("total_fob_value_pkr") != null) ? rs.getBigDecimal("total_fob_value_pkr").toPlainString() : null);
					 exp.setTotal_fob_value_usd((rs.getString("total_fob_value_usd") != null) ? rs.getBigDecimal("total_fob_value_usd").toPlainString() : null);
					 exp.setTotal_invoice_value((rs.getString("total_invoice_value") != null) ? rs.getBigDecimal("total_invoice_value").toPlainString() : null);
					 exp.setTotal_invoice_value_cif_usd((rs.getString("total_invoice_value_cif_usd") != null) ? rs.getBigDecimal("total_invoice_value_cif_usd").toPlainString() : null);
					 exp.setTotal_invoice_value_usd((rs.getString("total_invoice_value_usd") != null) ? rs.getBigDecimal("total_invoice_value_usd").toPlainString() : null);
					 
					 exp.setTotal_value_etb((rs.getString("total_value_etb") != null) ? rs.getBigDecimal("total_value_etb").toPlainString() : null);
					 ...
					 exp.setUnit_price((rs.getString("unit_price")  != null) ? rs.getBigDecimal("unit_price").toPlainString() : null);
					 ...
					 exp.setUnit_price_usd((rs.getString("unit_price_usd") != null) ? rs.getBigDecimal("unit_price_usd").toPlainString() : null);
					 exp.setTotal_value_bdt((rs.getString("total_value_bdt") != null) ? rs.getBigDecimal("total_value_bdt").toPlainString() : null);
					 exp.setTotal_value_usd((rs.getString("total_value_usd") != null) ? rs.getBigDecimal("total_value_usd").toPlainString() : null);
					 
					 exp.setCif_value_usd((rs.getString("cif_value_usd") != null) ? rs.getBigDecimal("cif_value_usd").toPlainString() : null);
					 exp.setUnit_value_cif_usd((rs.getString("unit_value_cif_usd") != null) ? rs.getBigDecimal("unit_value_cif_usd").toPlainString() : null);
			 ...
			 while(rs.next()) {
				 ...
				 imp.setAssed_unit_value((rs.getString("assed_unit_value") != null) ? rs.getBigDecimal("assed_unit_value").toPlainString() : null);
				 
				 imp.setAssessed_import_value_pkr((rs.getBigDecimal("assessed_import_value_pkr") != null) ? rs.getBigDecimal("assessed_import_value_pkr").toPlainString() : null);
				 imp.setAssessed_value((rs.getString("assessed_value") != null) ? rs.getBigDecimal("assessed_value").toPlainString() : null);
				 ...
				 imp.setCif_unit_price((rs.getString("cif_unit_price") != null) ? rs.getBigDecimal("cif_unit_price").toPlainString() : null);
				 imp.setCif_value_botswanan_pula((rs.getString("cif_value_botswanan_pula") != null) ? rs.getBigDecimal("cif_value_botswanan_pula").toPlainString() : null);
				 imp.setCommercial_deposit(rs.getString("commercial_deposit"));
				 imp.setCommercial_quantity((rs.getString("commercial_quantity") != null) ? rs.getBigDecimal("commercial_quantity").toPlainString() : null);
				 ...
				 imp.setDuty((rs.getString("duty") != null) ? rs.getBigDecimal("duty").toPlainString() : null);
				 imp.setDuty_mod(rs.getString("duty_mod"));
				 imp.setEconomic_zone(rs.getString("economic_zone"));
				 imp.setExchange_rate((rs.getString("exchange_rate") != null) ? rs.getBigDecimal("exchange_rate").toPlainString() : null);
				 ...
				 imp.setFob_value_botswanan_pula((rs.getString("fob_value_botswanan_pula") != null) ? rs.getBigDecimal("fob_value_botswanan_pula").toPlainString() : null);
				 imp.setFreight_value_botswanan_pula((rs.getString("freight_value_botswanan_pula") != null) ? rs.getBigDecimal("freight_value_botswanan_pula").toPlainString() : null);
				 imp.setFreight_value_usd((rs.getString("freight_value_usd") != null) ? rs.getBigDecimal("freight_value_usd").toPlainString() : null);
				 imp.setGross_weight((rs.getString("gross_weight") != null) ? rs.getBigDecimal("gross_weight").toPlainString() : null);
				 ...
				 imp.setItem_value_cif((rs.getString("item_value_cif") != null) ? rs.getBigDecimal("item_value_cif").toPlainString() : null);
				 imp.setItem_value_fob((rs.getString("item_value_fob") != null) ? rs.getBigDecimal("item_value_fob").toPlainString() : null);
				 ...
				 imp.setNet_weight((rs.getString("net_weight") != null) ? rs.getBigDecimal("net_weight").toPlainString() : null);
				 imp.setNet_weight_unit(rs.getString("net_weight_unit"));
				 imp.setNo_of_package((rs.getString("no_of_package") != null) ? rs.getBigDecimal("no_of_package").toPlainString() : null);
				 ...
				 imp.setQuantity((rs.getString("quantity") != null) ? rs.getBigDecimal("quantity").toPlainString() : null);
				 imp.setShip_name(rs.getString("ship_name"));
				 imp.setStd_quantity((rs.getString("std_quantity") != null) ? rs.getBigDecimal("std_quantity").toPlainString() : null);
				 imp.setStd_unit(rs.getString("std_unit"));
				 imp.setSubitem_no(rs.getString("subitem_no"));
				 imp.setTax_amount((rs.getString("tax_amount") != null) ? rs.getBigDecimal("tax_amount").toPlainString() : null);
				 imp.setTax_percentge(rs.getString("tax_percentge"));
				 imp.setTotal_freight_value((rs.getString("total_freight_value") != null) ? rs.getBigDecimal("total_freight_value").toPlainString() : null);
				 imp.setTotal_insurance_value((rs.getString("total_insurance_value") != null) ? rs.getBigDecimal("total_insurance_value").toPlainString() : null);
				 imp.setTotal_invoice_value((rs.getString("total_invoice_value") != null) ? rs.getBigDecimal("total_invoice_value").toPlainString() : null);
				 imp.setTotal_invoice_value_usd((rs.getString("total_invoice_value_usd") != null) ? rs.getBigDecimal("total_invoice_value_usd").toPlainString() : null);
				 imp.setTotal_value((rs.getString("total_value") != null) ? rs.getBigDecimal("total_value").toPlainString() : null);
				 imp.setTotal_value_bdt((rs.getString("total_value_bdt") != null) ? rs.getBigDecimal("total_value_bdt").toPlainString() : null);
				 imp.setTotal_value_cif((rs.getString("total_value_cif") != null) ? rs.getBigDecimal("total_value_cif").toPlainString() : null);
				 imp.setTotal_value_cif_naira((rs.getString("total_value_cif_naira") != null) ? rs.getBigDecimal("total_value_cif_naira").toPlainString() : null);
				 imp.setTotal_value_cif_ugx((rs.getString("total_value_cif_ugx") != null) ? rs.getBigDecimal("total_value_cif_ugx").toPlainString() : null);
				 imp.setTotal_value_cif_usd((rs.getString("total_value_cif_usd") != null) ? rs.getBigDecimal("total_value_cif_usd").toPlainString() : null);
				 imp.setTotal_value_cif_zwd((rs.getString("total_value_cif_zwd") != null) ? rs.getBigDecimal("total_value_cif_zwd").toPlainString() : null);
				 imp.setTotal_value_etb((rs.getString("total_value_etb") != null) ? rs.getBigDecimal("total_value_etb").toPlainString() : null);
				 imp.setTotal_value_kes((rs.getString("total_value_kes") != null) ? rs.getBigDecimal("total_value_kes").toPlainString() : null);
				 imp.setTotal_value_lsl((rs.getString("total_value_lsl") != null) ? rs.getBigDecimal("total_value_lsl").toPlainString() : null);
				 imp.setTotal_value_naira((rs.getString("total_value_naira") != null) ? rs.getBigDecimal("total_value_naira").toPlainString() : null);
				 imp.setTotal_value_uah((rs.getString("total_value_uah") != null) ? rs.getBigDecimal("total_value_uah").toPlainString() : null);
				 imp.setTotal_value_usd((rs.getString("total_value_usd") != null) ? rs.getBigDecimal("total_value_usd").toPlainString() : null);
				 ...
				 imp.setUnit_price((rs.getString("unit_price") != null) ? rs.getBigDecimal("unit_price").toPlainString() : null);
				 imp.setUnit_price_bdt((rs.getString("unit_price_bdt") != null) ? rs.getBigDecimal("unit_price_bdt").toPlainString() : null);
				 imp.setUnit_price_kes((rs.getString("unit_price_kes") != null) ? rs.getBigDecimal("unit_price_kes").toPlainString() : null);
				 imp.setUnit_price_usd((rs.getString("unit_price_usd") != null) ? rs.getBigDecimal("unit_price_usd").toPlainString() : null);
				 imp.setValue_added_tax_amount((rs.getString("value_added_tax_amount") != null) ? rs.getBigDecimal("value_added_tax_amount").toPlainString() : null);
			...
			if(userSearchRequest.getTradeType().getValue() == "EXPORT")
			{
				 ...
				 while(rs.next()) {
					 ...
					 ExpInd expInd = new ExpInd();
					  ...
					  expInd.setUnit_rate_in_foreign_currency(Double.parseDouble(String.format("%.2f",rs.getDouble("unit_rate_in_foreign_currency"))));
					  expInd.setUnit_rate_currency(rs.getString("unit_rate_currency"));
					  expInd.setTotal_sb_value_in_inr_in_lacs(Double.parseDouble(String.format("%.2f",rs.getDouble("total_sb_value_in_inr_in_lacs"))));
					  ...
					  expInd.setDrawback_excise(Double.parseDouble(String.format("%.2f",rs.getDouble("drawback_excise"))));
					  expInd.setDrawback_customs(Double.parseDouble(String.format("%.2f",rs.getDouble("drawback_customs"))));
			 ...
			 while(rs.next()) {
				 ...
				 ImpInd impInd = new ImpInd();
				  ...
				  impInd.setApplicable_duty(Double.parseDouble(String.format("%.2f",rs.getDouble("applicable_duty"))));
				  ...
				  impInd.setTotal_duty_on_entire_be(Double.parseDouble(String.format("%.2f",rs.getDouble("total_duty_on_entire_be"))));
